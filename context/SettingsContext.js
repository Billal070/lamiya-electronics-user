...
const translations = {
  en: {
    ...
    prop_backup: "Uninterrupted Backup",
    prop_backup_desc: "100% Guaranteed Service",
    prop_original: "Original Products",
    prop_original_desc: "Imported directly from brands",
    prop_delivery: "Fast Home Delivery",
    prop_delivery_desc: "Across Bangladesh",
    prop_return: "Easy Return",
    prop_return_desc: "7 Days Replacement Warranty",
  ...
  bn: {
    ...
    prop_backup: "নিরবচ্ছিন্ন ব্যাকআপ",
    prop_backup_desc: "১০০% গ্যারান্টিড সেবা",
    prop_original: "অরিজিনাল প্রোডাক্ট",
    prop_original_desc: "সরাসরি ব্র্যান্ড থেকে আমদানিকৃত",
    prop_delivery: "দ্রুত হোম ডেলিভারি",
    prop_delivery_desc: "সমগ্র বাংলাদেশ জুড়ে",
    prop_return: "সহজ ইজি রিটার্ন",
    prop_return_desc: "৭ দিনের রিপ্লেসমেন্ট ওয়ারেন্টি",
