  ...
  return (
    <div className="bg-white rounded-xl shadow-sm hover:shadow-md border border-gray-100 overflow-hidden flex flex-col group transition-all duration-300">
      ...
      <div className="p-3 md:p-4 flex flex-col flex-grow">
        ...
        <Link href={`/product/${product.slug}`} className="font-semibold text-brandDark hover:text-brandBlue line-clamp-2 text-xs md:text-base leading-tight mb-2 h-8 md:h-10">
          {product.name}
        </Link>
